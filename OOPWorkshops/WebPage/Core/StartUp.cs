...
namespace WebPage.Core
{
    public class StartUp
    {
            ...
            while (true)
            {
                ...
                foreach (ParameterInfo param in parameters)
                {
                    if (param.ParameterType.IsPrimitive)
                    {
                        ...
                        arguments[index] = Convert.ChangeType(value, param.ParameterType, null);
                        index++;
                    }
                    else
                    {
                        ...
                        arguments[index] = Convert.ChangeType(bindingModel, bindingModelType, null);
                        index++;
                    }
                }
                IInvokable result = (IInvokable)method.Invoke(controller, arguments);
                result.Invoke();
            }
        }
        ...
        static void RegistereControllers(string controllersFolder = "Controllers", string controllerSuffix = "Controller")
        {
